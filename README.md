<h1 align="center">🎙️ VoiceMint: WisprFlow Alternative</h1>

<p align="center">
  A lightweight and accurate voice typing app for Linux Mint Cinnamon...<br />
  that costs less than <strong>$1 per month</strong>.
</p>
...
**⚠️ Important:** You _must_ log out and log back in (or restart your computer) right now for the group permission changes to take effect!
